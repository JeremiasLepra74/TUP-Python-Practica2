...
# NO MODIFICAR - INICIO
print(maximo_cuadruple(1, 10, 5, -5)) == 10
print(maximo_cuadruple(4, 9, 18, 6)) == 18
print(maximo_cuadruple(24, 9, 18, 20)) == 24
print(maximo_cuadruple(24, 9, 18, 30))== 30
# NO MODIFICAR - FIN
...
def maximo_arbitrario(*args, sep=", ") -> float:
